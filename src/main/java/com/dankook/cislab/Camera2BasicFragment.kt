...
import com.dankook.cislab.ImageClassifier
...
class Camera2BasicFragment : Fragment(), FragmentCompat.OnRequestPermissionsResultCallback {
  ...
  private val stateCallback = object : CameraDevice.StateCallback() {
    ...
    override fun onOpened(currentCameraDevice: CameraDevice) {
      Log.d("TFLite Camera","onOpened")
      // This method is called when the camera is opened.  We start camera preview here.
      cameraOpenCloseLock.release()
      Log.d("currentCameraDevice",currentCameraDevice.toString())
    ...
    override fun onDisconnected(currentCameraDevice: CameraDevice) {
      Log.d("TFLite Camera","onDisconnected")
      cameraOpenCloseLock.release()
    ...
    override fun onError(
      ...
      Log.d("TFLite Camera","onError:" + error.toString() )
      cameraOpenCloseLock.release()
      currentCameraDevice.close()
      cameraDevice = null
...
//      drawView!!.setImgSize(classifier!!.imageSizeX, classifier!!.imageSizeY)
  ...
  private fun classifyFrame() {
    Log.d("TFLite classifier", classifier.toString());
    Log.d("TFLite activity", activity.toString());
    Log.d("TFLite cameraDevice", cameraDevice.toString());
